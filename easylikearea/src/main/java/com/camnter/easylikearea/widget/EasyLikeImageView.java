 ...
 */
package com.camnter.easylikearea.widget;
...
import com.camnter.easylikearea.R;
import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

/**
 * Description：EasyLikeImageView
 * Created by：CaMnter
 * Time：2016-03-23 15:03
 */
public class EasyLikeImageView extends ImageView {
    ...
    public EasyLikeImageView(Context context) {
        super(context);
        this.init(context, null);
    }


    public EasyLikeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }


    public EasyLikeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public EasyLikeImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.EasyLikeImageView);
        this.imageType =
                typedArray.getInt(R.styleable.EasyLikeImageView_easyLikeImageType, CIRCLE) == CIRCLE
                ? CIRCLE
                : ROUND;
        this.mBorderRadius = typedArray.getDimension(
                R.styleable.EasyLikeImageView_easyLikeImageBorderRadius,
